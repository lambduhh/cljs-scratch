...
var G__36633 = o;
goog.object.set(G__36633,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36635 = o;
goog.object.set(G__36635,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36663__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36664__i < G__36664__a.length) {G__36664__a[G__36664__i] = arguments[G__36664__i + 0]; ++G__36664__i;}
  args = new cljs.core.IndexedSeq(G__36664__a,0,null);
} 
return G__36663__delegate.call(this,args);};
G__36663.cljs$lang$maxFixedArity = 0;
G__36663.cljs$lang$applyTo = (function (arglist__36665){
var args = cljs.core.seq(arglist__36665);
return G__36663__delegate(args);
});
...
var G__36638 = props;
var G__36638__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36638,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36638);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36638__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36638__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36639 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36639,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36639;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36640){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36641__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__36643_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36643_SHARP_);
}));
} else {
return null;
}
...
var vec__36645 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36645,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36645,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36645,(2),null);
...
var temp__5739__auto___36671 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36671 == null)){
} else {
var key_36672 = temp__5739__auto___36671;
(jsprops.key = key_36672);
}
...
var temp__5739__auto___36673 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36673 == null)){
} else {
var key_36674 = temp__5739__auto___36673;
(jsprops.key = key_36674);
}
...
var G__36649 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36649) : reagent.impl.template.as_element.call(null,G__36649));
} else {
var temp__5739__auto___36675 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___36675 == null)){
} else {
var key_36676 = temp__5739__auto___36675;
(jsprops.key = key_36676);
}
...
var G__36651 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36651)){
return x;
} else {
...
while(true){
if((i__4737__auto___36679 < len__4736__auto___36677)){
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36652){
var G__36653 = cljs.core.first(seq36652);
var seq36652__$1 = cljs.core.next(seq36652);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36653,seq36652__$1);
}));
...
break;
default:
var G__36683 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36683;
continue;
...
var ctx = ({});
var vec__36656 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36656,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36656,(1),null);
...
var G__36659 = (cljs.core.count(argv) - first_child);
switch (G__36659) {
case (0):
