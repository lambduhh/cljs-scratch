...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26422 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26422(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26426 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26426(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26429 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26429(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26432 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26432(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26436 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26436(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26443 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26443(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26444 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26444(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26446 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26446(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26448 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26448(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26458 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26458(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26460 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26460(b);
}
});
